...
class FigureCaptionProcessor(BlockProcessor):
    ...
    def run(self, parent, blocks): # how to process the block?
        ...
        if captionText.strip() != "":
            ...
            figcaptionElem.text = "<em>Figure %d&nbsp;:</em> %s" % (self.n, captionText) #no clue why the text itself turns out as html again and not raw. Anyhow, it suits me, the blockparsers annoyingly wrapped everything into <p>.
